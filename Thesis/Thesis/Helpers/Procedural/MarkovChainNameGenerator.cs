...
namespace Thesis.Helpers.Procedural
{
    public class MarkovChainNameGenerator
    {
        ...
        private  Dictionary<string, Dictionary<string, float>> SeriesValue = new Dictionary<string, Dictionary<string, float>>();
        private  List<string> NamesToReturn;
        private  string finalString = "";
        private  Dictionary<string, Dictionary<string, float>> letterValue = new Dictionary<string, Dictionary<string, float>>();
        private  Dictionary<char, Dictionary<char, float>> letterValue2 = new Dictionary<char, Dictionary<char, float>>();
        private  List<string> AllNames = new List<string>();

        public MarkovChainNameGenerator(string choice)
        {
            Choice = choice;
            
            var pathToNames = System.Web.Hosting.HostingEnvironment.MapPath("~/Content/imiona_pl.csv"); // Habeeb, "Dubai Media City, Dubai"
            ...
            if (Names.Where(a => a[0].ToString().ToLower() == choice.ToLower()).Count() < 2 || Names.Count == 0)
            {
                ...
                pathToNames = System.Web.Hosting.HostingEnvironment.MapPath("~/Content/babies-first-names-2010-2018.csv"); ; // Habeeb, "Dubai Media City, Dubai"
                using (TextFieldParser ParserCsv = new TextFieldParser(pathToNames))
                {
                    ParserCsv.CommentTokens = new string[] { "#" };
                    ParserCsv.SetDelimiters(new string[] { ",", "'" });
        ...
        public List<string> ReturnAll(string choice)
        {
        ...
        public List<string> GetWordsN2Ver(string choice)
        {
        ...
        public List<string> GetWordsN1Ver(string choice)
        {
            Random rand = new Random();
            NamesToReturn = new List<string>();
        ...
        public List<string> GetWordsN0Ver(char choice)
        {
            Random rand = new Random();
            NamesToReturn = new List<string>();
            while (NamesToReturn.Count <= 30)
        ...
        private  string GetWord1(Dictionary<string, Dictionary<string, float>> seriesValue, Random rand)
        {
        ...
        private  Dictionary<string, Dictionary<string, float>> InitalState1(Random rand, string choice, string returnTooMany = null)
        {
            finalString = "";
        ...
        private  string GetWord2(string choice)
        {
            string finalString = "" + choice;
            Random rand = new Random();
        ...
        private  void GenereteValuesToKeys2(string choice, Dictionary<string, float> counterForLetter, Dictionary<string, Dictionary<string, float>> letterValue)
        {
            Names.ForEach(a =>
            {
                a = a.ToLower();
        ...
        private  void InitializeLetterValue3(Dictionary<char, float> counterForLetter, Dictionary<char, Dictionary<char, float>> letterValue, char choice)
        {
            Names.ForEach(a =>
            {
                a = a.ToLower();
        ...
        private  string GetWord3(char choice)
        {
            string finalString = "" + choice;
            Random rand = new Random();
